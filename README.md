...
**Математическое обоснование**: Пространство делится на воксели размера $text{voxel\_size}$. Все точки внутри одного вокселя заменяются одной представительной точкой. Это уменьшает вычислительную сложность и устраняет избыточность данных.
